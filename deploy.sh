...
echo "    • Set Supabase URL + anon key via scripts/generate-bw-config.mjs (see SUPABASE_SETUP.md)"
echo "    • Deploy edge functions and configure auth redirect URLs (see SUPABASE_SETUP.md)"
echo "    • Run npm run integrity before shipping"
echo ""
