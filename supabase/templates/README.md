...
### Redirect URL
Ensure **Confirm email** is enabled and these URLs are allow-listed in **Authentication → URL Configuration**:
- `https://app.bluewaterintel.com/?confirmed=1` (web signups)
- `https://app.bluewaterintel.com/email-confirmed.html?confirmed=1` (native app signups)
