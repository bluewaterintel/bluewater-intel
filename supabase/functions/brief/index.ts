...
- SPECIES PROFILE: when biteScores[].speciesProfile is present, that is this app's habitat for that fish (tempIdealF, depthBandsFt, habitat, baits, tips, seasonNote). Use it for preferred temperature, depth, structure, and baits. Do not substitute another species' habits. California halibut are a sand and bay fish; white seabass are a kelp and hard-bottom fish. Neither is Atlantic fluke or weakfish.
