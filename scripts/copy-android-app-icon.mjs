...
writeAdaptiveXml();
// Capacitor template vector overrides density PNGs on API 24+ and shows the default robot.
const capDefaultForeground = join(res, "drawable-v24/ic_launcher_foreground.xml");
if (existsSync(capDefaultForeground)) {
  rmSync(capDefaultForeground);
  console.log("Removed Capacitor default drawable-v24/ic_launcher_foreground.xml");
}
copySplash();
