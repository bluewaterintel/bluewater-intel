...
PAYWALL="ios/App/Pods/RevenueCat/Sources/Paywalls/PaywallColor.swift"
if [ -f "$PAYWALL" ]; then
...
echo ""
echo "OK. Stay in this directory (repo root), then:"
echo "  open \"$ROOT/ios/App/App.xcworkspace\""
